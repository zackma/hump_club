...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tWechatFansList" checkbox="true" pagination="true" fitColumns="true" title="t_wechat_fans" actionUrl="tWechatFansController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="密码"  field="password"  queryMode="group"  width="120"></t:dgCol>
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="tWechatFansController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="tWechatFansController.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="tWechatFansController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
 ...
 <script src = "webpage/com/jeecg/com.hump.wechatuser/tWechatFansList.js"></script>		
